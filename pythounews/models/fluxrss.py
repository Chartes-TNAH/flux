...
class Sujet_fluxrss(db.Model):
    ...
    def afficher_rss(flux):
        ...
        :rtype liste_flux : list
        """
        # En premier lieu, on compare l'id des mots-clés
        # celui entré en paramètre de la méthode statique et ceux présents dans la table Sujet_fluxrss
        # récupère toutes les informations de la classe Sujet_fluxrss dont l'id du sujet du flux rss entré dans la
        # table Sujet_fluxrss correspond à l'id qui est en paramètre de la méthode statique.
        ...
        for rss in sujet_flux:
            ...
            # On récupère dans la table Fluxrss toutes les informations pour chaque flux dont l'id du flux correspond
            # à l'id des flux entrés dans la table Sujet_flux
        ...
        # On ne retourne finalement que les flux rss dont l'id des mots-clés
        # correspondent à l'id utilisé en paramètre de la méthode statique.
        return liste_flux
